...
(function () {
  ...
  var translations = {
    en: {
      ...
      exp_subtitle: 'Choose from different game worlds in large, open play areas.',
      ...
      detail_sessions_subtitle: 'Groups rotate quickly and smoothly, so everyone gets a turn.',
      ...
      detail_pricing_subtitle: 'What you see is what you pay, no surprises afterwards.',
    ...
    nl: {
      ...
      exp_subtitle: 'Kies uit verschillende gamewerelden in grote, vrije speelruimtes.',
      ...
      detail_sessions_subtitle: 'Groepen wisselen snel en soepel, zodat iedereen aan de beurt komt.',
      ...
      detail_pricing_subtitle: 'Wat je ziet is wat je betaalt, zonder verrassingen achteraf.',
